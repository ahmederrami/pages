...
const About = () => {
  return (
    ...
    <p className={styles.par}>Grande agence de voyages, filiale de l’Office National des Chemins de Fer,
    ...
    <p className={styles.par}>Connue pour son efficacité et sa rigueur dans la conception de ses prestations
    ...
    Patrimoine Mondial – UNESCO…</p>
    <p className={styles.par}>En relation avec l’activité de voyage, Supratours Travel a développé ces
    dernières années des services associés au transport ferroviaire à savoir :</p>
    <ul>
        <li>Nettoyage du matériel roulant voyageurs ;</li>
        <li>Gestion des parkings ;</li>
        <li>Gestion immobilière des gares et des dortoirs du personnel roulant ;</li>
